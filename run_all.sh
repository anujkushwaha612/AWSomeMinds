...
stage llm_check            -u -m ber.llm_judge check                   # optional stage 3 (v5.llm.enabled)
...
say "If v5.llm.enabled: subs/sub_v5_llm exists; upload it only if artifacts/v5/llm.json says verdict KEEP."
